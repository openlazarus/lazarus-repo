// NOTE: Billing-related tables and RPC functions are intentionally excluded
// from this file. Self-hosters can ignore billing entirely; in the hosted
// deployment, billing is handled by an external service. See the
// self-hosting docs for details. If regenerating this file from Supabase,
// re-apply the same exclusion list.
