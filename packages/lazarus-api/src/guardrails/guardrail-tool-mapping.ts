...
const CATEGORY_TOOL_MAP: Record<string, string[]> = {
  ...
  external_connections: [
    ...
    // Givebutter (read operations)
    'mcp__givebutter__list_contacts',
    'mcp__givebutter__get_contact',
    'mcp__givebutter__list_contact_activities',
    'mcp__givebutter__get_contact_activity',
    'mcp__givebutter__list_campaigns',
    'mcp__givebutter__get_campaign',
    'mcp__givebutter__list_campaign_members',
    'mcp__givebutter__get_campaign_member',
    'mcp__givebutter__list_campaign_teams',
    'mcp__givebutter__get_campaign_team',
    'mcp__givebutter__list_campaign_tickets',
    'mcp__givebutter__get_campaign_ticket',
    'mcp__givebutter__list_campaign_discount_codes',
    'mcp__givebutter__get_campaign_discount_code',
    'mcp__givebutter__list_transactions',
    'mcp__givebutter__get_transaction',
    'mcp__givebutter__list_payouts',
    'mcp__givebutter__get_payout',
    'mcp__givebutter__list_plans',
    'mcp__givebutter__get_plan',
    'mcp__givebutter__list_tickets',
    'mcp__givebutter__get_ticket',
    'mcp__givebutter__list_funds',
    'mcp__givebutter__get_fund',
    'mcp__givebutter__list_households',
    'mcp__givebutter__get_household',
    'mcp__givebutter__list_household_contacts',
    'mcp__givebutter__get_household_contact',
    'mcp__givebutter__list_messages',
    'mcp__givebutter__get_message',
    'mcp__givebutter__list_pledges',
    'mcp__givebutter__get_pledge',
    'mcp__givebutter__list_webhooks',
    'mcp__givebutter__get_webhook',
    'mcp__givebutter__list_webhook_activities',
    'mcp__givebutter__get_webhook_activity',
    'mcp__givebutter__list_all_contacts',
    'mcp__givebutter__list_all_contact_activities',
    'mcp__givebutter__list_all_campaigns',
    'mcp__givebutter__list_all_campaign_members',
    'mcp__givebutter__list_all_campaign_teams',
    'mcp__givebutter__list_all_campaign_tickets',
    'mcp__givebutter__list_all_campaign_discount_codes',
    'mcp__givebutter__list_all_transactions',
    'mcp__givebutter__list_all_payouts',
    'mcp__givebutter__list_all_plans',
    'mcp__givebutter__list_all_tickets',
    'mcp__givebutter__list_all_funds',
    'mcp__givebutter__list_all_households',
    'mcp__givebutter__list_all_household_contacts',
    'mcp__givebutter__list_all_messages',
    'mcp__givebutter__list_all_pledges',
    'mcp__givebutter__list_all_webhooks',
    'mcp__givebutter__list_all_webhook_activities',
  ],
  ...
  send_messages: [
    ...
    // Givebutter (write operations)
    'mcp__givebutter__create_contact',
    'mcp__givebutter__update_contact',
    'mcp__givebutter__archive_contact',
    'mcp__givebutter__restore_contact',
    'mcp__givebutter__add_contact_tags',
    'mcp__givebutter__remove_contact_tags',
    'mcp__givebutter__sync_contact_tags',
    'mcp__givebutter__create_contact_activity',
    'mcp__givebutter__update_contact_activity',
    'mcp__givebutter__delete_contact_activity',
    'mcp__givebutter__create_campaign',
    'mcp__givebutter__update_campaign',
    'mcp__givebutter__archive_campaign',
    'mcp__givebutter__delete_campaign_member',
    'mcp__givebutter__delete_campaign_team',
    'mcp__givebutter__create_campaign_ticket',
    'mcp__givebutter__create_campaign_discount_code',
    'mcp__givebutter__update_campaign_discount_code',
    'mcp__givebutter__delete_campaign_discount_code',
    'mcp__givebutter__create_transaction',
    'mcp__givebutter__update_transaction',
    'mcp__givebutter__create_fund',
    'mcp__givebutter__update_fund',
    'mcp__givebutter__archive_fund',
    'mcp__givebutter__create_household',
    'mcp__givebutter__update_household',
    'mcp__givebutter__delete_household',
    'mcp__givebutter__add_contact_to_household',
    'mcp__givebutter__remove_contact_from_household',
    'mcp__givebutter__create_webhook',
    'mcp__givebutter__update_webhook',
    'mcp__givebutter__delete_webhook',
  ],
